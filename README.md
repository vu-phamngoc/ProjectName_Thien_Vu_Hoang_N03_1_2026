...
- Người dùng muốn vừa quản lý công việc, vừa có động lực “cày EXP” như game.
...
2. Hệ thống **EXP và Level**  
3. **Achievement** (Thành tựu)  
4. **Daily Quest** (Nhiệm vụ hằng ngày)  
5. **Friend System** (Kết bạn)  
6. **Leaderboard** (Bảng xếp hạng)  
7. **Activity Feed** (Bảng tin hoạt động)
...
1. **Hoàn thành task:** User → Cập nhật Task → Tính EXP → Update User → Check Achievement → Tạo Activity → Update UI  
2. **Kết bạn:** User gửi lời mời → Accept → Cập nhật Friend List  
3. **Leaderboard:** Query Users theo EXP → Hiển thị top  
4. **Activity Feed:** Query Activities → Filter theo friend → Hiển thị timeline  
...
- Người dùng sẽ thấy **động lực làm việc tăng lên**.  
- Báo cáo và slide trình bày có **sơ đồ hệ thống, mockup UI, flow hoạt động đầy đủ**.  

---

## 11. Tiêu chí đánh giá
- Hoàn thiện chức năng cơ bản (Task, EXP, Level)  
- Có tính năng cộng đồng (Friend, Leaderboard, Feed)  
- UI/UX thân thiện, có animation  
- Code rõ ràng, kiến trúc chuẩn  
- Demo trơn tru, báo cáo chi tiết, slide minh họa